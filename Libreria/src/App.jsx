...
function App() {
  ...
  try {
    ...
    await pb.collection("Libri").delete(record.id);

    setLibri(prev =>
      prev.filter(libro => libro.id !== record.id)
    );
  ...
  return (
    <div id="main">
      <h1>MyLibrary</h1>
      <Tasto testo="Aggiungi" funzione={aggiungiLibro} />
      <Tasto testo="Elimina" funzione={eliminaLibro}/>
